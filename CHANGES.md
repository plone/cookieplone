...
- Display an error screen, instead of a traceback, when the template repository cannot be used: either it is not found for the given tag, or it has no `cookiecutter.json` file at its root. @ericof [#210](https://github.com/plone/cookieplone/issues/210)


### Internal:

- Pin the default template repository tag to `20260810.1`. @ericof [#210](https://github.com/plone/cookieplone/issues/210)
